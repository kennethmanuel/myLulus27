...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navNama : TextView? = headerView?.findViewById(R.id.txtNamaMhs)
        val navNrp : TextView? = headerView?.findViewById(R.id.txtNrpMhs)
        ...
        navNama?.text = Global.nama
        navNrp?.text = Global.nrp
        ...
        navView.setNavigationItemSelectedListener {
            ...
            if(it.itemId == R.id.itemKuliah){
                ...
                val sendIntent = Intent().apply {
                    ...
                    this.data = Uri.parse("mailto:") //Only handle email apps
                    ...
                    this.putExtra(Intent.EXTRA_TEXT, "Halo, perkenalkan nama saya ${Global.nama} dengan NRP ${Global.nrp}. Saya ingin memberitahu bahwa ada bug di dalam aplikasi saya. Terima kasih.")
